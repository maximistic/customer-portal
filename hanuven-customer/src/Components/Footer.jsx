...
import { faFacebookF, faXTwitter, faYoutube, faPinterestP, faInstagram } from '@fortawesome/free-brands-svg-icons';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold mb-4">Tell us what you think...</h3>
          ...
          <div className="text-center md:text-left">
            <div className="flex justify-center md:justify-start mb-4">
              <img src="src/Components/Assets/logo.png" alt="Logo" className="h-16" />
            </div>
